    ...
    public static Item getMobHead(int mob) {
        switch (mob) {
            case Skeleton.NETWORK_ID:
                return Item.get(ItemNamespaceId.SKELETON_SKULL);
            case WitherSkeleton.NETWORK_ID:
                return Item.get(ItemNamespaceId.WITHER_SKELETON_SKULL);
            case Zombie.NETWORK_ID:
                return Item.get(ItemNamespaceId.ZOMBIE_HEAD);
            case Creeper.NETWORK_ID:
                return Item.get(ItemNamespaceId.CREEPER_HEAD);
            default:
                return null;
        }
    }
