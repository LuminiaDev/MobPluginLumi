...
public class Cow extends WalkingAnimal {
    ...
    public boolean targetOption(EntityCreature creature, double distance) {
        if (creature instanceof Player) {
            ...
            return player.isAlive() && !player.closed && player.getInventory() != null && player.getInventory().getItemInHand() != null && player.getInventory().getItemInHand().getId() == Item.WHEAT && distance <= 49;
        }
