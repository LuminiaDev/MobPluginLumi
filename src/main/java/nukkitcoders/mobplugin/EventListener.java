...
public class EventListener {
    ...
    public EventListener(MobPlugin plugin) {
        //PlayerMoveEvent
        plugin.getServer().getPluginManager().subscribeEvent(PlayerMoveEvent.class, ev -> {
        ...
        }, EventPriority.MONITOR, true, plugin);
        ...
        //EntityDeathEvent
        plugin.getServer().getPluginManager().subscribeEvent(EntityDeathEvent.class, ev -> {
        ...
        //PlayerDeathEvent
        plugin.getServer().getPluginManager().subscribeEvent(PlayerDeathEvent.class, ev -> {
            this.handleAttackedEntityAngry(ev.getEntity());
        }, EventPriority.MONITOR, true, plugin);
    }
